...
BLOG_AUTHOR = "Roger Wang"  # (translatable)
BLOG_TITLE = "Blog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://ccrogerwang.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "roger77622@gmail.com"
BLOG_DESCRIPTION = "Welcome"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
                   ...
                   ('https://github.com/CCRogerWang', 'About me', 'icon-user'),
                   ('https://github.com/CCRogerWang', 'My Github', 'icon-github'),
                   )
}
